...
def get_full_std_lib_module(name='pyscript-std.py'):
    code = '/*PyScript std lib. Autogenerated and licensed by BSD-2-clause.*/\n'
    code += 'var mod = {};\n'
    code += get_partial_std_lib(FUNCTIONS.keys(), METHODS.keys(), 0,
                                'mod.f_', 'mod.m_')
    code = code.replace(FUNCTION_PREFIX, 'mod.f_').replace(METHOD_PREFIX, 'mod.m_')
    return JSModule(name, code, imports=[], exports='mod')
