...
class FlaskServer(AbstractServer):
    ...
    def _open(self, host, port, **kwargs):
        ...
        # Hook Flask up with asyncio. Flexx' BaseServer makes sure
        # that the correct asyncio event loop is current (for this thread).
        # http://www.tornadoweb.org/en/stable/asyncio.html
        # todo: Since Flask v5.0 asyncio is autom used, deprecating AsyncIOMainLoop
        self._io_loop = AsyncIOMainLoop()
        # I am sorry for this hack, but Flask wont work otherwise :(
        # I wonder how long it will take before this will bite me back. I guess
        # we will be alright as long as there is no other Flask stuff going on.
...
class FlexxHandler(RequestHandler):
    """ Base class for Flexx' Flask request handlers.
    """
...
class WSHandler(WebSocketHandler):
    ...
    def close(self, *args):
        try:
            ...
            WebSocketHandler.close(self)  # older Flask
