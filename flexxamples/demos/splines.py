...
class SplineWidget(flx.CanvasWidget):
    ...
    tension = flx.FloatProp(
        0.5, settable=True, doc="""
...
class Splines(flx.Widget):
    def init(self):
        ...
        with flx.HBox():
            ...
            with flx.VBox(flex=1):
                ...
                self.spline = SplineWidget(flex=1, closed=lambda: closed.checked,
    ...
    @flx.reaction('b1.checked', 'b2.checked', 'b3.checked', 'b4.checked', 'b5.checked',
                  'b6.checked')
